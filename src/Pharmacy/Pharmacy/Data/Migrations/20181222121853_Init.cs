        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Neighborhood = table.Column<string>(maxLength: 64, nullable: true),
                    Line1 = table.Column<string>(maxLength: 512, nullable: true),
                    Line2 = table.Column<string>(maxLength: 512, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dosage = table.Column<string>(maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceSupports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceSupports_Insurances_InsuranceId",
                        column: x => x.InsuranceId,
                        principalTable: "Insurances",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InsuranceSupports_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_Scripts_ScriptId",
                        column: x => x.ScriptId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScriptDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScriptDetails_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScriptDetails_Scripts_ScriptId",
                        column: x => x.ScriptId,
                        principalTable: "Scripts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_ScriptDetails_ScriptDetailId",
                        column: x => x.ScriptDetailId,
                        principalTable: "ScriptDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "InsuranceSupports",
                column: "InsuranceId");

            migrationBuilder.CreateIndex(
                name: "IX_InsuranceSupports_MedicineId",
                table: "InsuranceSupports",
                column: "MedicineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_ScriptDetailId",
                table: "OrderDetails",
                column: "ScriptDetailId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_MedicineId",
                table: "Products",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_ScriptDetails_MedicineId",
                table: "ScriptDetails",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_ScriptDetails_ScriptId",
                table: "ScriptDetails",
                column: "ScriptId");
